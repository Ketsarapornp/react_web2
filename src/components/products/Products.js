...
function Products() {
    const products = [
        ...
        { id: 2, name: "RAM", price: 1500, stock: 10, photo: './images/a1.jpg' },
        { id: 3, name: "SDD", price: 5000, stock: 19, photo: './images/a2.jpg' },
        { id: 4, name: "ROM", price: 1500, stock: 10, photo: './images/a3.jpg' },
        { id: 5, name: "Somy", price: 8000, stock: 25, photo: './images/a4.jpg' },
    ]
    return (
        <Row>
            {products.map((item) =>{
